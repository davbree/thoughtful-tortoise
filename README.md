...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://dca0aab8287a.ngrok.io/pull/6034e0b4306b7a5a0fa1acd7
...
To start editing your site, you can use the Sanity interface at https://thoughtful-tortoise-4e0b4.sanity.studio/.
...
Generated at `2021-02-23T11:02:34.343Z` by Stackbit version `0.3.49`.